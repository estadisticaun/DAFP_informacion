...
```{r fig9_1, fig.align='center', out.width='47%', fig.show='hold', echo=FALSE}
...
<img src="Imagenes/Deser1.png">

---
### 3.1 Prueba 31

```{r fig3, fig.align='center', out.width='47%', fig.show='hold', echo=FALSE}
knitr::include_graphics('Imagenes/Deser1.png')
```
<font size=2><b>Disponible en: </b><a href="https://raw.githubusercontent.com/estadisticaun/L_Conceptual/master/imagenes/F_9.png?token=AHYPBYXQ2ZQXAQDE7VOR7ILAXYMBM">Capítulo 3. Gestión de la Información en las Universidades.</a></font>
...
knitr::include_graphics('Imagenes/F91.png')
```
<font size=2><b>Disponible en: </b><a href="https://raw.githubusercontent.com/estadisticaun/L_Conceptual/master/imagenes/F_9.png?token=AHYPBYXQ2ZQXAQDE7VOR7ILAXYMBM">Capítulo 3. Gestión de la Información en las Universidades.</a></font>
]
